...
.modal {
  @apply overflow-x-auto flex flex-col bg-gray-100 dark:bg-gray-800 bg-opacity-50 dark:bg-opacity-75 backdrop-filter backdrop-blur border border-gray-800 dark:border-gray-100 border-opacity-10 dark:border-opacity-10 rounded-lg shadow-2xl;
}
