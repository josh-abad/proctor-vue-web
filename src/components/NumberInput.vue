...
.button-icon {
  @apply fill-current w-5 h-5 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white;
}

.button-disabled {
  @apply text-gray-400 hover:text-gray-400 dark:text-gray-600 dark:hover:text-gray-600;
}
